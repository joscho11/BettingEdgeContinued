...
This folder is display data. Training lives in private producer repositories.

| Path | What the site reads |
|---|---|
...
2026 weekly files do not come from this folder. They are published through `publishing/` into `data/releases/`.
