...
| 4 | `build_value_board.py` | `value_board_{season}.csv` | **RETIRED tab data.** The Draft Value Finder tab was removed on 2026-07-12. This script still loads Model A pkls, ranks the drafted pool vs ADP, and emits BUY/FADE calls with the incoming-competition and injury guards. It is kept for history. It does not feed any live page. |
...
python fantasy/seasonal_projections/build_value_board.py           # RETIRED engine: value_board_{season}.csv
