# 2026 Draft Board Model Proj

The Draft Board reads `independent_half_ppr_points_2026.csv` as Model Proj.
That file is a copied, read-only publication artifact. This repository does not
train, re-score, or alter it.
...
- The dashboard separately refreshes Sleeper ADP and Sleeper projection points
  daily over these exact 180 players, then recomputes live ranks and gaps.
