...
def render():
    ...
    st.caption(
        ...
        "Talent uses each position's dedicated college charting build, including past "
        "draft classes on the same anchored scale. An uncovered player stays blank "
        "(outside FBS, or below a volume floor). The older box-score fallback is 2026-only. "
        "The builds carry no "
