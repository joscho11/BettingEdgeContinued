...
The **All-Time Leaderboard** replaces the old table-first records view with headline leaders, a win-rate-versus-adjusted-scoring map, and a ranked win-rate chart. Eight cards in two rows of four: Most Titles, Most Finals Appearances, Longest Active Playoff Streak, Best Win %, Most Points, Most Toilet Bowl Titles, Most Toilet Bracket Finals Appearances, and Lowest Scoring Team. Each card has an info icon. One or two count leaders share a card by name. Two names stack so they stay on the card, including a long single name. Three or more show as an N-way tie, with each tie as its own bullet under the cards. Most Points is the sum of regular-season weekly scores in the window, excluding playoffs, and is not era-adjusted. Most Finals Appearances counts championship games as champ or runner-up. Longest Active Playoff Streak counts consecutive playoff seasons through the latest completed postseason in the window. An in-progress year does not reset it. Toilet Bowl Titles count the winner of that season's consolation championship, the toilet bowl. That is last place. Same tie rules as championship titles. A manager who later left the league still counts if they won that game. Toilet Bracket Finals Appearances count toilet bowl championship games as champ or runner-up. Lowest Scoring Team is regular-season points per game. All Time needs more than 2 seasons, so a one-year disaster does not take it. The map still uses weekly scoring versus that week's league average.
