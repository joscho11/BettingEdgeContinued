...
The **All-Time Leaderboard** replaces the old table-first records view with headline leaders, a win-rate-versus-adjusted-scoring map, and a ranked win-rate chart. Cards are Most Titles, Most Finals Appearances, Longest Active Playoff Streak, Best Win %, and Most Points. Each card has an info icon. One or two count leaders share a card by name. Three or more show as an N-way tie, with the names under the cards. Most Points is the sum of regular-season weekly scores in the window, excluding playoffs, and is not era-adjusted. Most Finals Appearances counts championship games as champ or runner-up. Longest Active Playoff Streak counts consecutive playoff seasons through the latest completed postseason in the window. An in-progress year does not reset it. The map still uses weekly scoring versus that week's league average.
