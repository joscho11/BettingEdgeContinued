...
- U5B-1 - AGENTS.md vs reality - the app is now an st.Page MULTIPAGE app (app.py 70
  lines; page_*.py files; test_site_nav/test_board_page/test_betting_pages/
  test_fantasy_league_pages/test_help_page in CI) while AGENTS.md still describes a
