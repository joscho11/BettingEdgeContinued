...
- **`site_pages/page_futures.py`** — Season Totals (Beta). READ-ONLY over `futures/published/` leftover-mix files from `seasonal_totals_v2_beta` (`python src/publish_site.py`). Language fence: `futures/language_fence.py`. Old M4-c pipeline: `archive/legacy-futures-m4c-2026-08-18/`. Tests: `tests/test_page_futures.py`.
